...
It can also be seen that the Grid and Hexagonal Coverage increase the total area from roughly 7,837,583 to 8,479,014
and	8,545,891 respectively.
...
NID2019 <- read_excel("data/NID2019_U.xlsx")
...
As the each tessellation aggregates the data differently ie the shape and scale of the aggregation unit it creates bias. As can be see in the Grid and Hexagonal coverages, where they appeared to increase the top level of point counts, meaning the high end of the gradient was 500-600 this caused the plot to loose some of the original definition in the west side of the country. While Voroni and triangulation appeared to decrease the top level of point counts it was a much smaller difference (original county data: 300 to voroni/triangulation: 200). This allowed these graphs to look similar to the original data although it was aggregated differently.
...
##### Comment of geographic distribution of dams you found. Does it make sense? How does the distribution of dams coiencide with other geogaphic factors such as river systems, climate, etc?

The water supply dams appear to be concentrated heavily in California and upper mid possibly Wyoming, Nebraska, South Dakota. There are a few scattered in Texas and the north east around Massachusetts, Connecticut and New York. 
The large amount of water supply dams in California and even in Texas is likely because they are both drier states. Especially in California where droughts are common so access to a water supply dam would be relevant.
