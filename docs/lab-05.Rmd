...
#### - examine impacts on the town of Palo in Iowa 
...
##### You can visualize the uncertainty the classifications by summing the entire stack. The higher the count in each pixel, the more certain you can be about its flooded state. Meaning for a cell with a value of 6 every method identified the cell as flooded. While a cell with a value of 2, two of the methods identified the cell as flooded.
